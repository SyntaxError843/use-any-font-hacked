...
<div class="dcform">
    <form method="post" action="">
        ...
        <p>
            <label>Regenerate Font Entries [Hacked]</label>
            <span class="field">
                <select name="uaf_regenerate_font_entries">
                    <option value="0">No</option>
                    <option value="1">Yes</option>
                </select>
                ( An added option to regenerate font entries in database after manually adding the woff files in the plugin upload dir located in `wp-content/uploads/useanyfont` )
            </span>
        </p>
